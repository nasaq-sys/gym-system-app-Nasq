...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-xs text-foreground/70 data-inset:ps-7.5",
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ms-auto text-3xs tracking-widest text-foreground/70 group-focus/dropdown-menu-item:text-accent-foreground",
        className
      )}
      {...props}
    />
