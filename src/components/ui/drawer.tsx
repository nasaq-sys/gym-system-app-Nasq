      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Direction: left/right RTL flip. `start-0`/`end-0` above swap
            // sides under dir="rtl" (start-0 -> right edge, end-0 -> left
            // edge), but --closed-transform is a physical translateX and
            // does not auto-flip with logical positioning. Without this,
            // the drawer opens/closes toward the wrong edge in Arabic.
            "rtl:data-[swipe-direction=left]:[--closed-transform:translate3d(calc(100%+var(--drawer-inset,0px)+2px),0,0)]",
            "rtl:data-[swipe-direction=right]:[--closed-transform:translate3d(calc(-100%-var(--drawer-inset,0px)-2px),0,0)]",
            className
          )}
          {...props}
        >
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn(
        "text-xs/relaxed text-balance text-foreground/70",
        className
      )}
      {...props}
    />
